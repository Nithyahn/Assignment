  ...
  return (
    <div className="container py-14 ml-[40px] mr-[40px]">
      <div className="py-1 relative mb-2 gap-1">
        ...
        <h1 className="py-1 tracking-wider text-7xl font-extrabold capitalize text-center clash-display" style={{ lineHeight: '48px', fontSize: '48px', margin: '0', letterSpacing: '-3px' }}>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="py-20 sm:order-2">
          <div className="relative right-[-250px]">
            <h2 className="left-0 text-2xl mb-4 relative font-extrabold capitalize ml-1 clash-display">
